...
impl DistributedContext {
    ...
    fn new(bctx: QuipContext, cluster: Arc<Cluster>, me: Uuid) -> Self {
        DistributedContext {
            bctx,
            me,
            members: LOTable::new(),
    ...
    ///
    /// Exposes local quip context to distributed actor
    pub fn local_ctx(&self) -> &QuipContext {
        &self.bctx
    }
    ...
    /// Message needs to be stringified or apply the rules of quip's [Message] trait.
    ...
    F: Future<Output = Result<(), ()>> + Send + 'static,
{
    ...
    Quip::spawn(move |ctx: QuipContext| {
