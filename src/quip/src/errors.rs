//!
//! Describes the error types that may happen within quip.
//! Given Quip has a let it crash strategy, most error aren't noticeable.
...
use crate::{distributor::Distributor, message::QuipMessage};
...
///
/// [`try_recv`]: crate::context::QuipContext::try_recv
/// [`try_recv_timeout`]: crate::context::QuipContext::try_recv_timeout
...
pub enum SendError {
    ...
    /// that is not a QuipMessage::Message variant
    Other(anyhow::Error),
