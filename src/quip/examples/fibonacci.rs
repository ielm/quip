...
async fn fib_child_task(ctx: QuipContext) -> Result<(), ()> {
    loop {
        // This macro is weird.
        ...
        msg! { ctx.recv().await?,
            ...
            // and pass ctx as parameter, so that quip knows where to send the reply
            request: String =!> {
...
fn main() {
    ...
    // We need a quip in order to run everything
    Quip::init();
    Quip::start();
...
// [2020-05-08T14:00:53Z INFO  quip::system] System: Launched.
// [2020-05-08T14:00:53Z INFO  quip::system] System: Starting.
// [2020-05-08T14:00:53Z INFO  quip::system] System: Launching Supervisor(00000000-0000-0000-0000-000000000000).
...
// [2020-05-08T14:00:55Z INFO  quip::system] System: Stopping.
