...
/// Jan 31 14:55:56.678  WARN hello_tokio: sleeping for 2 seconds without using the quip executor
...
/// Jan 31 14:56:15.679  WARN hello_tokio: we're done, stopping the quip!
#[cfg(feature = "tokio-runtime")]
#[tokio::main]
async fn main() -> AnyResult<()> {
            ...
            async move {
                ...
                msg! {
                    ...
                    msg: &'static str => {
                        ...
                        warn!("sleeping for 2 seconds without using the quip executor");
    ...
    warn!("we're done, asking quip to stop!");
    // We are done, stopping the quip!
    Quip::stop();
    warn!("quip stopped!");
    Ok(())
}
